...
if 'enable_screenshots' not in st.session_state:
    st.session_state.enable_screenshots = False
if 'enable_analysis' not in st.session_state:
    st.session_state.enable_analysis = False
...
def run_scraper(urls, progress_bar, status_text):
    ...
    scraper = EnhancedWebScraper(
        enable_screenshots=st.session_state.get('enable_screenshots', False),
        enable_analysis=st.session_state.get('enable_analysis', False)
    )
...
st.session_state.enable_screenshots = st.sidebar.checkbox("Take Screenshots", value=st.session_state.enable_screenshots, help="Enable to capture screenshots of scraped pages")
st.session_state.enable_analysis = st.sidebar.checkbox("Content Analysis", value=st.session_state.enable_analysis, help="Enable to analyze content using AI")
